...
export default function Home() {
  ...
  return <>
    <section className="hero">
      <div className="hero-copy"><p className="eyebrow"><span className="status-dot" /> AI engineering · London</p><h1><span>Saroswat Roy</span>{profile.headline}</h1><p className="hero-intro">{profile.statement}</p><div className="button-row"><Link className="button primary" href="/projects">View projects <span aria-hidden="true">↗</span></Link><a className="button secondary" href="/documents/saroswat-roy-resume.pdf" download>Download résumé</a><Link className="text-link" href="/contact">Start a conversation</Link></div></div>
